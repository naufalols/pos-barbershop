...
class Pengguna extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->has_userdata('username')) {
            ...
            $data['cukur'] = $this->Pengguna_model->getAllActive('tk_cukur');
            ...
            // print_r($data['keranjangcukur']);
            // die();
            $data['title'] = 'Menu';

            $this->load->view('template/auth_header', $data);
            $this->load->view('pengguna/pos/pos', $data);
    ...
    public function penjualan()
    {
        if ($this->session->has_userdata('username')) {
            ...
            $this->load->view('template/auth_header', $data);
            $this->load->view('pengguna/penjualan/penjualan', $data);
            $this->load->view('template/auth_modal', $data);
            $this->load->view('template/auth_footer');
        } else {
            redirect('auth');
