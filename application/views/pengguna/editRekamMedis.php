            ...
            <div class="card-body">
              <form method="post" action="<?= base_url('pengguna/editRekamMedis'); ?>">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label>Nama</label>
                    <input type="text" style="text-transform: uppercase;"  class="form-control" id="nama" name="nama" placeholder="Nama Lengkap" value="<?= $rekammedis['nama']; ?>">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" style="text-transform: uppercase;" class="form-control" id="pekerjaan" name="pekerjaan" placeholder="Pekerjaan" value="<?= $rekammedis['pekerjaan']; ?>">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                   ...
                   <!--  <select id="kecamatan" class="form-control" name="kecamatan" required>
                    ...
                    <input type="text" style="text-transform: uppercase" class="form-control" id="kecamatan" name="kecamatan" placeholder="Kecamatan" value="<?= $rekammedis['kecamatan']; ?>">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" style="text-transform: uppercase" class="form-control" id="kelurahan" name="kelurahan" placeholder="Kelurahan" value="<?= $rekammedis['kelurahan']; ?>">
                    <?= form_error('kelurahan', '<small class="text-danger pl-3">', '</small>'); ?>

                  </div>
                  <div class="form-group col-md-6">
                    <label>Dusun</label>
                    <input type="text" style="text-transform: uppercase" class="form-control" id="dusun" name="dusun" placeholder="Dusun" value="<?= $rekammedis['dusun']; ?>">
